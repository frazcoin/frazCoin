...
- Alternatively run frazCoin-qt.exe or frazCoind.exe without using the installer

frazCoin-Qt is the original frazCoin client and it builds the backbone of the network.

However, it downloads and stores the entire history of frazCoin transactions;
