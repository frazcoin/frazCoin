    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a frazCoin address (e.g. FDoZn8qX9HYyW5nYvLaNzzL5H6PDG3dcnH)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid frazCoin address"));
        }
        else
        {
